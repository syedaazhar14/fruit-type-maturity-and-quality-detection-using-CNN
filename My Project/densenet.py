...
train_images, train_labels, train_subclass_labels = load_images_and_labels("360/train")
test_images, test_labels, test_subclass_labels = load_images_and_labels("360/test")
valid_images, valid_labels, valid_subclass_labels = load_images_and_labels("360/valid")
...
model.save("densenet_modelapple.h5", include_optimizer=False)
np.save('le_main_classes_densenetapple.npy', le_main.classes_)
np.save('le_subclass_classes_densenetapple.npy', le_subclass.classes_)
