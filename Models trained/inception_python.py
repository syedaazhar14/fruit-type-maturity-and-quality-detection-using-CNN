...
def predict_image(image_path, model_path, le_main_classes_path, le_subclass_classes_path):
    model = load_model(model_path)
    le_main_classes = np.load(le_main_classes_path, allow_pickle=True)
    le_subclass_classes = np.load(le_subclass_classes_path, allow_pickle=True)
    ...
    le_main.classes_ = le_main_classes
    le_subclass = LabelEncoder()
    le_subclass.classes_ = le_subclass_classes
...
def main():
    ...
    train_images, train_labels, train_subclass_labels = load_images_and_labels("temp/train")
    test_images, test_labels, test_subclass_labels = load_images_and_labels("temp/test")
    valid_images, valid_labels, valid_subclass_labels = load_images_and_labels("temp/valid")
    ...
    np.save('le_main_classes_incept.npy', le_main.classes_)
    np.save('le_subclass_classes_incept.npy', le_subclass.classes_)
